...
AsyncWebSocket ws('/ws'); //dedicated web
...
void webSocketEvent(uint8_t num, WStype_t type, uint8_t * payload, size_t length) { // When a WebSocket message is received
  switch (type) {
    ...
    case WStype_TEXT:                     // if new text data is received
      ...
      if (payload[0] == 'toggleGPIO_0_off') {//note: these strings are just algorithimic.
      ...
      if (payload[0] == 'toggleGPIO_0_on') {//note: these strings are just algorithimic.
      	//the console commands themselves can contain numbers but the corresponding
      	//char or string here can't. no worries though.
      ...
      if (payload[0] == 'toggleGPIO_1_off') {//note: these strings are just algorithimic.
      	//the console commands themselves can contain numbers but the corresponding
      	//char or string here can't. no worries though.
      ...
      if (payload[0] == 'toggleGPIO_1_on') {//note: these strings are just algorithimic.
      	//the console commands themselves can contain numbers but the corresponding
      	//char or string here can't. no worries though.
      ...
      // if (payload[0] == 'activate_water_sensing'){ //rough algorithim. 
      //this is gonna be implemented through SPIFFs
      //   Serial.begin(115200);
      //   //function();
      //   //writeFile();
      //   //return some value;
...
//🐉🐉🐉🐉🐉🐉🐉🐉🐉🐉🐉🐉🐉🐉🐉🐉🐉🐉🐉🐉🐉🐉🐉🐉🐉🐉🐉🐉
//here be dragons: this is ALL spiffs file config. ignore this for now.
//🐉🐉🐉🐉🐉🐉🐉🐉🐉🐉🐉🐉🐉🐉🐉🐉🐉🐉🐉🐉🐉🐉🐉🐉🐉🐉🐉🐉
...
sample = 12;
strcpy(sample, obj["sample"], sizeof(sample);
strcpy(hp, obj["volume"], sizeof(volume);
